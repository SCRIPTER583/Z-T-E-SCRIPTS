...
collectorBtn.Position = UDim2.new(0.1, 0, 0.55, 0)
...
submitBtn.Position = UDim2.new(0.1, 0, 0.8, 0)
submitBtn.BackgroundColor3 = Color3.fromRGB(70, 140, 255)
submitBtn.Text = "Auto Submit"
...
submitBtn.MouseButton1Click:Connect(function()
	...
	submitBtn.BackgroundColor3 = submitting and Color3.fromRGB(255, 60, 60) or Color3.fromRGB(70, 140, 255)
	if submitting then
		coroutine.wrap(function()
			while submitting do
				local char = player.Character or player.CharacterAdded:Wait()
